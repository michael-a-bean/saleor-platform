...
export const RangeFilter = ({
	...
	const [prevValue, setPrevValue] = useState({ min: value.min, max: value.max });
	if (value.min !== prevValue.min || value.max !== prevValue.max) {
		setPrevValue({ min: value.min, max: value.max });
